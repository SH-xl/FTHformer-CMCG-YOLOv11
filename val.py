...
if __name__ == '__main__':
    model_path = r'E:\JSH\ultralytics-yolo11\runs\gk-voc\yolo11-CGAFusion-MPCA-zgC3k2_ConvFormerCGLU\weights\best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data=r'E:\JSH\ultralytics-yolo11\data\data.yaml',
